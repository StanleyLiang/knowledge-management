...
const VIEWER_DEMO_STATE = {
  root: {
    children: [
      // ── H1: Title ──
      h('h1', [t('Lexical Viewer — Feature Showcase')]),

      p([t('This document demonstrates every supported node type rendered in read-only mode.')]),
  ...
  return (
    <div>
      ...
      <div className="border border-gray-200 rounded-lg">
        <Viewer initialEditorState={JSON.stringify(VIEWER_DEMO_STATE)} showTableOfContents showPresentationButton />
      </div>
    </div>
  )
}
